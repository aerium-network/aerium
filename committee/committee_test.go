...
func TestProtocolVersionPercentages(t *testing.T) {
	...
	val2.UpdateProtocolVersion(protocol.ProtocolVersionUnknown)
	val3.UpdateProtocolVersion(protocol.ProtocolVersion1)
	val4.UpdateProtocolVersion(protocol.ProtocolVersion1)
	val5.UpdateProtocolVersion(protocol.ProtocolVersion1)
	...
	assert.Equal(t, float64(50), percentages[protocol.ProtocolVersionUnknown])
	assert.Equal(t, float64(50), percentages[protocol.ProtocolVersion1])
}
...
func TestSupportProtocolVersion(t *testing.T) {
	...
	supportVer1 := cmt.SupportProtocolVersion(protocol.ProtocolVersionUnknown)
	supportVer2 := cmt.SupportProtocolVersion(protocol.ProtocolVersion1)
