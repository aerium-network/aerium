...
pub mod transaction_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Transaction", "GetTransaction"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Transaction", "CalculateFee"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Transaction", "BroadcastTransaction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aerium.Transaction", "GetRawTransferTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Transaction", "GetRawBondTransaction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aerium.Transaction", "GetRawUnbondTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aerium.Transaction", "GetRawWithdrawTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Transaction", "DecodeRawTransaction"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod transaction_server {
    ...
    impl<T: Transaction> tonic::server::NamedService for TransactionServer<T> {
        const NAME: &'static str = "aerium.Transaction";
    }
}
/// Generated client implementations.
pub mod blockchain_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetBlock"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetBlockHash"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetBlockHeight"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetBlockchainInfo"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetConsensusInfo"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetAccount"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetValidator"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetValidatorByNumber"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetValidatorAddresses"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetPublicKey"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Blockchain", "GetTxPoolContent"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod blockchain_server {
    ...
    impl<T: Blockchain> tonic::server::NamedService for BlockchainServer<T> {
        const NAME: &'static str = "aerium.Blockchain";
    }
}
/// Generated client implementations.
pub mod network_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Network", "GetNetworkInfo"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Network", "GetNodeInfo"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod network_server {
    ...
    impl<T: Network> tonic::server::NamedService for NetworkServer<T> {
        const NAME: &'static str = "aerium.Network";
    }
}
/// Generated client implementations.
pub mod utils_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Utils", "SignMessageWithPrivateKey"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Utils", "VerifyMessage"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Utils", "PublicKeyAggregation"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Utils", "SignatureAggregation"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod utils_server {
    ...
    impl<T: Utils> tonic::server::NamedService for UtilsServer<T> {
        const NAME: &'static str = "aerium.Utils";
    }
}
/// Generated client implementations.
pub mod wallet_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "CreateWallet"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "RestoreWallet"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/aerium.Wallet/LoadWallet");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("aerium.Wallet", "LoadWallet"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "UnloadWallet"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "GetTotalBalance"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "SignRawTransaction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "GetValidatorAddress"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "GetNewAddress"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "GetAddressHistory"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("aerium.Wallet", "SignMessage"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "GetTotalStake"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "GetAddressInfo"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "SetAddressLabel"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/aerium.Wallet/ListWallet");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("aerium.Wallet", "ListWallet"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aerium.Wallet", "GetWalletInfo"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("aerium.Wallet", "ListAddress"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod wallet_server {
    ...
    impl<T: Wallet> tonic::server::NamedService for WalletServer<T> {
        const NAME: &'static str = "aerium.Wallet";
    }
}
