...
type GetBlockRequest struct {
	...
	Verbosity     BlockVerbosity `protobuf:"varint,2,opt,name=verbosity,proto3,enum=aerium.BlockVerbosity" json:"verbosity,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetTxPoolContentRequest struct {
	...
	PayloadType   PayloadType `protobuf:"varint,1,opt,name=payload_type,json=payloadType,proto3,enum=aerium.PayloadType" json:"payload_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VoteInfo struct {
	...
	Type VoteType `protobuf:"varint,1,opt,name=type,proto3,enum=aerium.VoteType" json:"type,omitempty"`
...
const file_blockchain_proto_rawDesc = "" +
	"\n" +
	"\x10blockchain.proto\x12\x06aerium\x1a\x11transaction.proto\"-\n" +
	"\x11GetAccountRequest\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\"C\n" +
	"\x12GetAccountResponse\x12-\n" +
	"\aaccount\x18\x01 \x01(\v2\x13.aerium.AccountInfoR\aaccount\"\x1e\n" +
	...
	"\tvalidator\x18\x01 \x01(\v2\x15.aerium.ValidatorInfoR\tvalidator\"/\n" +
	...
	"\tverbosity\x18\x02 \x01(\x0e2\x16.aerium.BlockVerbosityR\tverbosity\"\x83\x02\n" +
	...
	"\x06header\x18\x05 \x01(\v2\x17.aerium.BlockHeaderInfoR\x06header\x124\n" +
	"\tprev_cert\x18\x06 \x01(\v2\x17.aerium.CertificateInfoR\bprevCert\x12)\n" +
	"\x03txs\x18\a \x03(\v2\x17.aerium.TransactionInfoR\x03txs\"-\n" +
	...
	"\x14committee_validators\x18\a \x03(\v2\x15.aerium.ValidatorInfoR\x13committeeValidators\x12\x1b\n" +
	...
	"\x1bcommittee_protocol_versions\x18\v \x03(\v2@.aerium.GetBlockchainInfoResponse.CommitteeProtocolVersionsEntryR\x19committeeProtocolVersions\x1aL\n" +
	...
	"\bproposal\x18\x01 \x01(\v2\x14.aerium.ProposalInfoR\bproposal\x123\n" +
	"\tinstances\x18\x02 \x03(\v2\x15.aerium.ConsensusInfoR\tinstances\"Q\n" +
	"\x17GetTxPoolContentRequest\x126\n" +
	"\fpayload_type\x18\x01 \x01(\x0e2\x13.aerium.PayloadTypeR\vpayloadType\"E\n" +
	"\x18GetTxPoolContentResponse\x12)\n" +
	"\x03txs\x18\x01 \x03(\v2\x17.aerium.TransactionInfoR\x03txs\"\x87\x03\n" +
	...
	"\bVoteInfo\x12$\n" +
	"\x04type\x18\x01 \x01(\x0e2\x10.aerium.VoteTypeR\x04type\x12\x14\n" +
	...
	"\x05votes\x18\x05 \x03(\v2\x10.aerium.VoteInfoR\x05votes\"y\n" +
	...
	"\n" +
	"Blockchain\x12=\n" +
	"\bGetBlock\x12\x17.aerium.GetBlockRequest\x1a\x18.aerium.GetBlockResponse\x12I\n" +
	"\fGetBlockHash\x12\x1b.aerium.GetBlockHashRequest\x1a\x1c.aerium.GetBlockHashResponse\x12O\n" +
	...
	"\x10GetConsensusInfo\x12\x1f.aerium.GetConsensusInfoRequest\x1a .aerium.GetConsensusInfoResponse\x12C\n" +
	"\n" +
	"GetAccount\x12\x19.aerium.GetAccountRequest\x1a\x1a.aerium.GetAccountResponse\x12I\n" +
	"\fGetValidator\x12\x1b.aerium.GetValidatorRequest\x1a\x1c.aerium.GetValidatorResponse\x12Y\n" +
	"\x14GetValidatorByNumber\x12#.aerium.GetValidatorByNumberRequest\x1a\x1c.aerium.GetValidatorResponse\x12d\n" +
	"\x15GetValidatorAddresses\x12$.aerium.GetValidatorAddressesRequest\x1a%.aerium.GetValidatorAddressesResponse\x12I\n" +
	"\fGetPublicKey\x12\x1b.aerium.GetPublicKeyRequest\x1a\x1c.aerium.GetPublicKeyResponse\x12U\n" +
	"\x10GetTxPoolContent\x12\x1f.aerium.GetTxPoolContentRequest\x1a .aerium.GetTxPoolContentResponseB:\n" +
	"\x06aeriumZ0github.com/aerium-network/aerium/www/grpc/aeriumb\x06proto3"
...
var file_blockchain_proto_goTypes = []any{
	(BlockVerbosity)(0),                   // 0: aerium.BlockVerbosity
	(VoteType)(0),                         // 1: aerium.VoteType
	(*GetAccountRequest)(nil),             // 2: aerium.GetAccountRequest
	(*GetAccountResponse)(nil),            // 3: aerium.GetAccountResponse
	(*GetValidatorAddressesRequest)(nil),  // 4: aerium.GetValidatorAddressesRequest
	(*GetValidatorAddressesResponse)(nil), // 5: aerium.GetValidatorAddressesResponse
	(*GetValidatorRequest)(nil),           // 6: aerium.GetValidatorRequest
	(*GetValidatorByNumberRequest)(nil),   // 7: aerium.GetValidatorByNumberRequest
	(*GetValidatorResponse)(nil),          // 8: aerium.GetValidatorResponse
	(*GetPublicKeyRequest)(nil),           // 9: aerium.GetPublicKeyRequest
	(*GetPublicKeyResponse)(nil),          // 10: aerium.GetPublicKeyResponse
	(*GetBlockRequest)(nil),               // 11: aerium.GetBlockRequest
	(*GetBlockResponse)(nil),              // 12: aerium.GetBlockResponse
	(*GetBlockHashRequest)(nil),           // 13: aerium.GetBlockHashRequest
	(*GetBlockHashResponse)(nil),          // 14: aerium.GetBlockHashResponse
	(*GetBlockHeightRequest)(nil),         // 15: aerium.GetBlockHeightRequest
	(*GetBlockHeightResponse)(nil),        // 16: aerium.GetBlockHeightResponse
	(*GetBlockchainInfoRequest)(nil),      // 17: aerium.GetBlockchainInfoRequest
	(*GetBlockchainInfoResponse)(nil),     // 18: aerium.GetBlockchainInfoResponse
	(*GetConsensusInfoRequest)(nil),       // 19: aerium.GetConsensusInfoRequest
	(*GetConsensusInfoResponse)(nil),      // 20: aerium.GetConsensusInfoResponse
	(*GetTxPoolContentRequest)(nil),       // 21: aerium.GetTxPoolContentRequest
	(*GetTxPoolContentResponse)(nil),      // 22: aerium.GetTxPoolContentResponse
	(*ValidatorInfo)(nil),                 // 23: aerium.ValidatorInfo
	(*AccountInfo)(nil),                   // 24: aerium.AccountInfo
	(*BlockHeaderInfo)(nil),               // 25: aerium.BlockHeaderInfo
	(*CertificateInfo)(nil),               // 26: aerium.CertificateInfo
	(*VoteInfo)(nil),                      // 27: aerium.VoteInfo
	(*ConsensusInfo)(nil),                 // 28: aerium.ConsensusInfo
	(*ProposalInfo)(nil),                  // 29: aerium.ProposalInfo
	nil,                                   // 30: aerium.GetBlockchainInfoResponse.CommitteeProtocolVersionsEntry
	(*TransactionInfo)(nil),               // 31: aerium.TransactionInfo
	(PayloadType)(0),                      // 32: aerium.PayloadType
}
var file_blockchain_proto_depIdxs = []int32{
	24, // 0: aerium.GetAccountResponse.account:type_name -> aerium.AccountInfo
	23, // 1: aerium.GetValidatorResponse.validator:type_name -> aerium.ValidatorInfo
	0,  // 2: aerium.GetBlockRequest.verbosity:type_name -> aerium.BlockVerbosity
	25, // 3: aerium.GetBlockResponse.header:type_name -> aerium.BlockHeaderInfo
	26, // 4: aerium.GetBlockResponse.prev_cert:type_name -> aerium.CertificateInfo
	31, // 5: aerium.GetBlockResponse.txs:type_name -> aerium.TransactionInfo
	23, // 6: aerium.GetBlockchainInfoResponse.committee_validators:type_name -> aerium.ValidatorInfo
	30, // 7: aerium.GetBlockchainInfoResponse.committee_protocol_versions:type_name -> aerium.GetBlockchainInfoResponse.CommitteeProtocolVersionsEntry
	29, // 8: aerium.GetConsensusInfoResponse.proposal:type_name -> aerium.ProposalInfo
	28, // 9: aerium.GetConsensusInfoResponse.instances:type_name -> aerium.ConsensusInfo
	32, // 10: aerium.GetTxPoolContentRequest.payload_type:type_name -> aerium.PayloadType
	31, // 11: aerium.GetTxPoolContentResponse.txs:type_name -> aerium.TransactionInfo
	1,  // 12: aerium.VoteInfo.type:type_name -> aerium.VoteType
	27, // 13: aerium.ConsensusInfo.votes:type_name -> aerium.VoteInfo
	11, // 14: aerium.Blockchain.GetBlock:input_type -> aerium.GetBlockRequest
	13, // 15: aerium.Blockchain.GetBlockHash:input_type -> aerium.GetBlockHashRequest
	15, // 16: aerium.Blockchain.GetBlockHeight:input_type -> aerium.GetBlockHeightRequest
	17, // 17: aerium.Blockchain.GetBlockchainInfo:input_type -> aerium.GetBlockchainInfoRequest
	19, // 18: aerium.Blockchain.GetConsensusInfo:input_type -> aerium.GetConsensusInfoRequest
	2,  // 19: aerium.Blockchain.GetAccount:input_type -> aerium.GetAccountRequest
	6,  // 20: aerium.Blockchain.GetValidator:input_type -> aerium.GetValidatorRequest
	7,  // 21: aerium.Blockchain.GetValidatorByNumber:input_type -> aerium.GetValidatorByNumberRequest
	4,  // 22: aerium.Blockchain.GetValidatorAddresses:input_type -> aerium.GetValidatorAddressesRequest
	9,  // 23: aerium.Blockchain.GetPublicKey:input_type -> aerium.GetPublicKeyRequest
	21, // 24: aerium.Blockchain.GetTxPoolContent:input_type -> aerium.GetTxPoolContentRequest
	12, // 25: aerium.Blockchain.GetBlock:output_type -> aerium.GetBlockResponse
	14, // 26: aerium.Blockchain.GetBlockHash:output_type -> aerium.GetBlockHashResponse
	16, // 27: aerium.Blockchain.GetBlockHeight:output_type -> aerium.GetBlockHeightResponse
	18, // 28: aerium.Blockchain.GetBlockchainInfo:output_type -> aerium.GetBlockchainInfoResponse
	20, // 29: aerium.Blockchain.GetConsensusInfo:output_type -> aerium.GetConsensusInfoResponse
	3,  // 30: aerium.Blockchain.GetAccount:output_type -> aerium.GetAccountResponse
	8,  // 31: aerium.Blockchain.GetValidator:output_type -> aerium.GetValidatorResponse
	8,  // 32: aerium.Blockchain.GetValidatorByNumber:output_type -> aerium.GetValidatorResponse
	5,  // 33: aerium.Blockchain.GetValidatorAddresses:output_type -> aerium.GetValidatorAddressesResponse
	10, // 34: aerium.Blockchain.GetPublicKey:output_type -> aerium.GetPublicKeyResponse
	22, // 35: aerium.Blockchain.GetTxPoolContent:output_type -> aerium.GetTxPoolContentResponse
