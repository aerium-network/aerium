...
func (s *BlockchainJsonRPC) Methods() map[string]func(ctx context.Context, message json.RawMessage) (any, error) {
	return map[string]func(ctx context.Context, params json.RawMessage) (any, error){
		...
		"aerium.blockchain.get_block": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_block_hash": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_block_height": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_blockchain_info": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_consensus_info": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_account": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_validator": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_validator_by_number": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_validator_addresses": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_public_key": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.blockchain.get_tx_pool_content": func(ctx context.Context, data json.RawMessage) (any, error) {
