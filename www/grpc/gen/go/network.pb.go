...
type PeerInfo struct {
	...
	Direction Direction `protobuf:"varint,13,opt,name=direction,proto3,enum=aerium.Direction" json:"direction,omitempty"`
...
const file_network_proto_rawDesc = "" +
	...
	"\x0fconnected_peers\x18\x03 \x03(\v2\x10.aerium.PeerInfoR\x0econnectedPeers\x123\n" +
	"\vmetric_info\x18\x04 \x01(\v2\x12.aerium.MetricInfoR\n" +
	"metricInfo\"\x14\n" +
	...
	"\x0fconnection_info\x18\x0e \x01(\v2\x16.aerium.ConnectionInfoR\x0econnectionInfo\x12?\n" +
	"\x0ezmq_publishers\x18\x0f \x03(\v2\x18.aerium.ZMQPublisherInfoR\rzmqPublishers\x12!\n" +
	...
	"\tdirection\x18\r \x01(\x0e2\x11.aerium.DirectionR\tdirection\x12\x1c\n" +
	...
	"\vmetric_info\x18\x11 \x01(\v2\x12.aerium.MetricInfoR\n" +
	"metricInfo\x12.\n" +
	...
	"\n" +
	"MetricInfo\x128\n" +
	"\rtotal_invalid\x18\x01 \x01(\v2\x13.aerium.CounterInfoR\ftotalInvalid\x122\n" +
	"\n" +
	"total_sent\x18\x02 \x01(\v2\x13.aerium.CounterInfoR\ttotalSent\x12:\n" +
	"\x0etotal_received\x18\x03 \x01(\v2\x13.aerium.CounterInfoR\rtotalReceived\x12F\n" +
	"\fmessage_sent\x18\x04 \x03(\v2#.aerium.MetricInfo.MessageSentEntryR\vmessageSent\x12R\n" +
	"\x10message_received\x18\x05 \x03(\v2'.aerium.MetricInfo.MessageReceivedEntryR\x0fmessageReceived\x1aS\n" +
	"\x10MessageSentEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.aerium.CounterInfoR\x05value:\x028\x01\x1aW\n" +
	"\x14MessageReceivedEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.aerium.CounterInfoR\x05value:\x028\x01\"=\n" +
	...
	"\aNetwork\x12O\n" +
	"\x0eGetNetworkInfo\x12\x1d.aerium.GetNetworkInfoRequest\x1a\x1e.aerium.GetNetworkInfoResponse\x12F\n" +
	"\vGetNodeInfo\x12\x1a.aerium.GetNodeInfoRequest\x1a\x1b.aerium.GetNodeInfoResponseB:\n" +
...
var file_network_proto_goTypes = []any{
	(Direction)(0),                 // 0: aerium.Direction
	(*GetNetworkInfoRequest)(nil),  // 1: aerium.GetNetworkInfoRequest
	(*GetNetworkInfoResponse)(nil), // 2: aerium.GetNetworkInfoResponse
	(*GetNodeInfoRequest)(nil),     // 3: aerium.GetNodeInfoRequest
	(*GetNodeInfoResponse)(nil),    // 4: aerium.GetNodeInfoResponse
	(*ZMQPublisherInfo)(nil),       // 5: aerium.ZMQPublisherInfo
	(*PeerInfo)(nil),               // 6: aerium.PeerInfo
	(*ConnectionInfo)(nil),         // 7: aerium.ConnectionInfo
	(*MetricInfo)(nil),             // 8: aerium.MetricInfo
	(*CounterInfo)(nil),            // 9: aerium.CounterInfo
	nil,                            // 10: aerium.MetricInfo.MessageSentEntry
	nil,                            // 11: aerium.MetricInfo.MessageReceivedEntry
}
var file_network_proto_depIdxs = []int32{
	6,  // 0: aerium.GetNetworkInfoResponse.connected_peers:type_name -> aerium.PeerInfo
	8,  // 1: aerium.GetNetworkInfoResponse.metric_info:type_name -> aerium.MetricInfo
	7,  // 2: aerium.GetNodeInfoResponse.connection_info:type_name -> aerium.ConnectionInfo
	5,  // 3: aerium.GetNodeInfoResponse.zmq_publishers:type_name -> aerium.ZMQPublisherInfo
	0,  // 4: aerium.PeerInfo.direction:type_name -> aerium.Direction
	8,  // 5: aerium.PeerInfo.metric_info:type_name -> aerium.MetricInfo
	9,  // 6: aerium.MetricInfo.total_invalid:type_name -> aerium.CounterInfo
	9,  // 7: aerium.MetricInfo.total_sent:type_name -> aerium.CounterInfo
	9,  // 8: aerium.MetricInfo.total_received:type_name -> aerium.CounterInfo
	10, // 9: aerium.MetricInfo.message_sent:type_name -> aerium.MetricInfo.MessageSentEntry
	11, // 10: aerium.MetricInfo.message_received:type_name -> aerium.MetricInfo.MessageReceivedEntry
	9,  // 11: aerium.MetricInfo.MessageSentEntry.value:type_name -> aerium.CounterInfo
	9,  // 12: aerium.MetricInfo.MessageReceivedEntry.value:type_name -> aerium.CounterInfo
	1,  // 13: aerium.Network.GetNetworkInfo:input_type -> aerium.GetNetworkInfoRequest
	3,  // 14: aerium.Network.GetNodeInfo:input_type -> aerium.GetNodeInfoRequest
	2,  // 15: aerium.Network.GetNetworkInfo:output_type -> aerium.GetNetworkInfoResponse
	4,  // 16: aerium.Network.GetNodeInfo:output_type -> aerium.GetNodeInfoResponse
