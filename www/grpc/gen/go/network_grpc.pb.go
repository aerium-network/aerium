...
const (
	Network_GetNetworkInfo_FullMethodName = "/aerium.Network/GetNetworkInfo"
	Network_GetNodeInfo_FullMethodName    = "/aerium.Network/GetNodeInfo"
)
