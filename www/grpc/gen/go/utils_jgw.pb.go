...
func (s *UtilsJsonRPC) Methods() map[string]func(ctx context.Context, message json.RawMessage) (any, error) {
	return map[string]func(ctx context.Context, params json.RawMessage) (any, error){
		...
		"aerium.utils.sign_message_with_private_key": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.utils.verify_message": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.utils.public_key_aggregation": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.utils.signature_aggregation": func(ctx context.Context, data json.RawMessage) (any, error) {
