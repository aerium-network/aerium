...
func (s *TransactionJsonRPC) Methods() map[string]func(ctx context.Context, message json.RawMessage) (any, error) {
	return map[string]func(ctx context.Context, params json.RawMessage) (any, error){
		...
		"aerium.transaction.get_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.calculate_fee": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.broadcast_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.get_raw_transfer_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.get_raw_bond_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.get_raw_unbond_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.get_raw_withdraw_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.get_raw_batch_transfer_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
		...
		"aerium.transaction.decode_raw_transaction": func(ctx context.Context, data json.RawMessage) (any, error) {
