...
type GetTransactionRequest struct {
	...
	Verbosity     TransactionVerbosity `protobuf:"varint,2,opt,name=verbosity,proto3,enum=aerium.TransactionVerbosity" json:"verbosity,omitempty"`
...
type CalculateFeeRequest struct {
	...
	PayloadType PayloadType `protobuf:"varint,2,opt,name=payload_type,json=payloadType,proto3,enum=aerium.PayloadType" json:"payload_type,omitempty"`
...
type TransactionInfo struct {
	...
	Fee int64 `protobuf:"varint,6,opt,name=fee,proto3" json:"fee,omitempty"`
	// The type of transaction payload.
	PayloadType PayloadType `protobuf:"varint,7,opt,name=payload_type,json=payloadType,proto3,enum=aerium.PayloadType" json:"payload_type,omitempty"`
	// Transaction payload.
	//
...
const file_transaction_proto_rawDesc = "" +
	"\n" +
	"\x11transaction.proto\x12\x06aerium\"c\n" +
	"\x15GetTransactionRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12:\n" +
	"\tverbosity\x18\x02 \x01(\x0e2\x1c.aerium.TransactionVerbosityR\tverbosity\"\x95\x01\n" +
	"\x16GetTransactionResponse\x12!\n" +
	"\fblock_height\x18\x01 \x01(\rR\vblockHeight\x12\x1d\n" +
	"\n" +
	"block_time\x18\x02 \x01(\rR\tblockTime\x129\n" +
	"\vtransaction\x18\x03 \x01(\v2\x17.aerium.TransactionInfoR\vtransaction\"\x88\x01\n" +
	"\x13CalculateFeeRequest\x12\x16\n" +
	"\x06amount\x18\x01 \x01(\x03R\x06amount\x126\n" +
	"\fpayload_type\x18\x02 \x01(\x0e2\x13.aerium.PayloadTypeR\vpayloadType\x12!\n" +
	...
	"\n" +
	"recipients\x18\x03 \x03(\v2\x11.aerium.RecipientR\n" +
	"recipients\x12\x10\n" +
	...
	"\n" +
	"recipients\x18\x02 \x03(\v2\x11.aerium.RecipientR\n" +
	"recipients\"?\n" +
	"\tRecipient\x12\x1a\n" +
	...
	"\fpayload_type\x18\a \x01(\x0e2\x13.aerium.PayloadTypeR\vpayloadType\x125\n" +
	"\btransfer\x18\x1e \x01(\v2\x17.aerium.PayloadTransferH\x00R\btransfer\x12)\n" +
	"\x04bond\x18\x1f \x01(\v2\x13.aerium.PayloadBondH\x00R\x04bond\x128\n" +
	"\tsortition\x18  \x01(\v2\x18.aerium.PayloadSortitionH\x00R\tsortition\x12/\n" +
	"\x06unbond\x18! \x01(\v2\x15.aerium.PayloadUnbondH\x00R\x06unbond\x125\n" +
	"\bwithdraw\x18\" \x01(\v2\x17.aerium.PayloadWithdrawH\x00R\bwithdraw\x12E\n" +
	"\x0ebatch_transfer\x18# \x01(\v2\x1c.aerium.PayloadBatchTransferH\x00R\rbatchTransfer\x12\x12\n" +
	...
	"\vtransaction\x18\x01 \x01(\v2\x17.aerium.TransactionInfoR\vtransaction*\xce\x01\n" +
	...
	"\fCalculateFee\x12\x1b.aerium.CalculateFeeRequest\x1a\x1c.aerium.CalculateFeeResponse\x12a\n" +
	"\x14BroadcastTransaction\x12#.aerium.BroadcastTransactionRequest\x1a$.aerium.BroadcastTransactionResponse\x12h\n" +
	"\x19GetRawTransferTransaction\x12(.aerium.GetRawTransferTransactionRequest\x1a!.aerium.GetRawTransactionResponse\x12`\n" +
	"\x15GetRawBondTransaction\x12$.aerium.GetRawBondTransactionRequest\x1a!.aerium.GetRawTransactionResponse\x12d\n" +
	...
	"\x1eGetRawBatchTransferTransaction\x12-.aerium.GetRawBatchTransferTransactionRequest\x1a!.aerium.GetRawTransactionResponse\x12a\n" +
	"\x14DecodeRawTransaction\x12#.aerium.DecodeRawTransactionRequest\x1a$.aerium.DecodeRawTransactionResponseB:\n" +
...
var file_transaction_proto_goTypes = []any{
	(PayloadType)(0),                              // 0: aerium.PayloadType
	(TransactionVerbosity)(0),                     // 1: aerium.TransactionVerbosity
	(*GetTransactionRequest)(nil),                 // 2: aerium.GetTransactionRequest
	(*GetTransactionResponse)(nil),                // 3: aerium.GetTransactionResponse
	(*CalculateFeeRequest)(nil),                   // 4: aerium.CalculateFeeRequest
	(*CalculateFeeResponse)(nil),                  // 5: aerium.CalculateFeeResponse
	(*BroadcastTransactionRequest)(nil),           // 6: aerium.BroadcastTransactionRequest
	(*BroadcastTransactionResponse)(nil),          // 7: aerium.BroadcastTransactionResponse
	(*GetRawTransferTransactionRequest)(nil),      // 8: aerium.GetRawTransferTransactionRequest
	(*GetRawBondTransactionRequest)(nil),          // 9: aerium.GetRawBondTransactionRequest
	(*GetRawUnbondTransactionRequest)(nil),        // 10: aerium.GetRawUnbondTransactionRequest
	(*GetRawWithdrawTransactionRequest)(nil),      // 11: aerium.GetRawWithdrawTransactionRequest
	(*GetRawBatchTransferTransactionRequest)(nil), // 12: aerium.GetRawBatchTransferTransactionRequest
	(*GetRawTransactionResponse)(nil),             // 13: aerium.GetRawTransactionResponse
	(*PayloadTransfer)(nil),                       // 14: aerium.PayloadTransfer
	(*PayloadBond)(nil),                           // 15: aerium.PayloadBond
	(*PayloadSortition)(nil),                      // 16: aerium.PayloadSortition
	(*PayloadUnbond)(nil),                         // 17: aerium.PayloadUnbond
	(*PayloadWithdraw)(nil),                       // 18: aerium.PayloadWithdraw
	(*PayloadBatchTransfer)(nil),                  // 19: aerium.PayloadBatchTransfer
	(*Recipient)(nil),                             // 20: aerium.Recipient
	(*TransactionInfo)(nil),                       // 21: aerium.TransactionInfo
	(*DecodeRawTransactionRequest)(nil),           // 22: aerium.DecodeRawTransactionRequest
	(*DecodeRawTransactionResponse)(nil),          // 23: aerium.DecodeRawTransactionResponse
}
var file_transaction_proto_depIdxs = []int32{
	1,  // 0: aerium.GetTransactionRequest.verbosity:type_name -> aerium.TransactionVerbosity
	21, // 1: aerium.GetTransactionResponse.transaction:type_name -> aerium.TransactionInfo
	0,  // 2: aerium.CalculateFeeRequest.payload_type:type_name -> aerium.PayloadType
	20, // 3: aerium.GetRawBatchTransferTransactionRequest.recipients:type_name -> aerium.Recipient
	20, // 4: aerium.PayloadBatchTransfer.recipients:type_name -> aerium.Recipient
	0,  // 5: aerium.TransactionInfo.payload_type:type_name -> aerium.PayloadType
	14, // 6: aerium.TransactionInfo.transfer:type_name -> aerium.PayloadTransfer
	15, // 7: aerium.TransactionInfo.bond:type_name -> aerium.PayloadBond
	16, // 8: aerium.TransactionInfo.sortition:type_name -> aerium.PayloadSortition
	17, // 9: aerium.TransactionInfo.unbond:type_name -> aerium.PayloadUnbond
	18, // 10: aerium.TransactionInfo.withdraw:type_name -> aerium.PayloadWithdraw
	19, // 11: aerium.TransactionInfo.batch_transfer:type_name -> aerium.PayloadBatchTransfer
	21, // 12: aerium.DecodeRawTransactionResponse.transaction:type_name -> aerium.TransactionInfo
	2,  // 13: aerium.Transaction.GetTransaction:input_type -> aerium.GetTransactionRequest
	4,  // 14: aerium.Transaction.CalculateFee:input_type -> aerium.CalculateFeeRequest
	6,  // 15: aerium.Transaction.BroadcastTransaction:input_type -> aerium.BroadcastTransactionRequest
	8,  // 16: aerium.Transaction.GetRawTransferTransaction:input_type -> aerium.GetRawTransferTransactionRequest
	9,  // 17: aerium.Transaction.GetRawBondTransaction:input_type -> aerium.GetRawBondTransactionRequest
	10, // 18: aerium.Transaction.GetRawUnbondTransaction:input_type -> aerium.GetRawUnbondTransactionRequest
	11, // 19: aerium.Transaction.GetRawWithdrawTransaction:input_type -> aerium.GetRawWithdrawTransactionRequest
	12, // 20: aerium.Transaction.GetRawBatchTransferTransaction:input_type -> aerium.GetRawBatchTransferTransactionRequest
	22, // 21: aerium.Transaction.DecodeRawTransaction:input_type -> aerium.DecodeRawTransactionRequest
	3,  // 22: aerium.Transaction.GetTransaction:output_type -> aerium.GetTransactionResponse
	5,  // 23: aerium.Transaction.CalculateFee:output_type -> aerium.CalculateFeeResponse
	7,  // 24: aerium.Transaction.BroadcastTransaction:output_type -> aerium.BroadcastTransactionResponse
	13, // 25: aerium.Transaction.GetRawTransferTransaction:output_type -> aerium.GetRawTransactionResponse
	13, // 26: aerium.Transaction.GetRawBondTransaction:output_type -> aerium.GetRawTransactionResponse
	13, // 27: aerium.Transaction.GetRawUnbondTransaction:output_type -> aerium.GetRawTransactionResponse
	13, // 28: aerium.Transaction.GetRawWithdrawTransaction:output_type -> aerium.GetRawTransactionResponse
	13, // 29: aerium.Transaction.GetRawBatchTransferTransaction:output_type -> aerium.GetRawTransactionResponse
	23, // 30: aerium.Transaction.DecodeRawTransaction:output_type -> aerium.DecodeRawTransactionResponse
