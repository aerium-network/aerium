...
public final class NetworkGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "aerium.Network";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<aerium.NetworkOuterClass.GetNetworkInfoRequest,
      aerium.NetworkOuterClass.GetNetworkInfoResponse> getGetNetworkInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetNetworkInfo",
      requestType = aerium.NetworkOuterClass.GetNetworkInfoRequest.class,
      responseType = aerium.NetworkOuterClass.GetNetworkInfoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<aerium.NetworkOuterClass.GetNetworkInfoRequest,
      aerium.NetworkOuterClass.GetNetworkInfoResponse> getGetNetworkInfoMethod() {
    io.grpc.MethodDescriptor<aerium.NetworkOuterClass.GetNetworkInfoRequest, aerium.NetworkOuterClass.GetNetworkInfoResponse> getGetNetworkInfoMethod;
      ...
      synchronized (NetworkGrpc.class) {
        if ((getGetNetworkInfoMethod = NetworkGrpc.getGetNetworkInfoMethod) == null) {
          NetworkGrpc.getGetNetworkInfoMethod = getGetNetworkInfoMethod =
              io.grpc.MethodDescriptor.<aerium.NetworkOuterClass.GetNetworkInfoRequest, aerium.NetworkOuterClass.GetNetworkInfoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetNetworkInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  aerium.NetworkOuterClass.GetNetworkInfoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  aerium.NetworkOuterClass.GetNetworkInfoResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<aerium.NetworkOuterClass.GetNodeInfoRequest,
      aerium.NetworkOuterClass.GetNodeInfoResponse> getGetNodeInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetNodeInfo",
      requestType = aerium.NetworkOuterClass.GetNodeInfoRequest.class,
      responseType = aerium.NetworkOuterClass.GetNodeInfoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<aerium.NetworkOuterClass.GetNodeInfoRequest,
      aerium.NetworkOuterClass.GetNodeInfoResponse> getGetNodeInfoMethod() {
    io.grpc.MethodDescriptor<aerium.NetworkOuterClass.GetNodeInfoRequest, aerium.NetworkOuterClass.GetNodeInfoResponse> getGetNodeInfoMethod;
    if ((getGetNodeInfoMethod = NetworkGrpc.getGetNodeInfoMethod) == null) {
      synchronized (NetworkGrpc.class) {
        if ((getGetNodeInfoMethod = NetworkGrpc.getGetNodeInfoMethod) == null) {
          NetworkGrpc.getGetNodeInfoMethod = getGetNodeInfoMethod =
              io.grpc.MethodDescriptor.<aerium.NetworkOuterClass.GetNodeInfoRequest, aerium.NetworkOuterClass.GetNodeInfoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetNodeInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  aerium.NetworkOuterClass.GetNodeInfoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  aerium.NetworkOuterClass.GetNodeInfoResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void getNetworkInfo(aerium.NetworkOuterClass.GetNetworkInfoRequest request,
        io.grpc.stub.StreamObserver<aerium.NetworkOuterClass.GetNetworkInfoResponse> responseObserver) {
    ...
    default void getNodeInfo(aerium.NetworkOuterClass.GetNodeInfoRequest request,
        io.grpc.stub.StreamObserver<aerium.NetworkOuterClass.GetNodeInfoResponse> responseObserver) {
  ...
  public static final class NetworkFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<aerium.NetworkOuterClass.GetNetworkInfoResponse> getNetworkInfo(
        aerium.NetworkOuterClass.GetNetworkInfoRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<aerium.NetworkOuterClass.GetNodeInfoResponse> getNodeInfo(
        aerium.NetworkOuterClass.GetNodeInfoRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_NETWORK_INFO:
          serviceImpl.getNetworkInfo((aerium.NetworkOuterClass.GetNetworkInfoRequest) request,
              (io.grpc.stub.StreamObserver<aerium.NetworkOuterClass.GetNetworkInfoResponse>) responseObserver);
          break;
        case METHODID_GET_NODE_INFO:
          serviceImpl.getNodeInfo((aerium.NetworkOuterClass.GetNodeInfoRequest) request,
              (io.grpc.stub.StreamObserver<aerium.NetworkOuterClass.GetNodeInfoResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              aerium.NetworkOuterClass.GetNetworkInfoRequest,
              aerium.NetworkOuterClass.GetNetworkInfoResponse>(
                service, METHODID_GET_NETWORK_INFO)))
        .addMethod(
          getGetNodeInfoMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              aerium.NetworkOuterClass.GetNodeInfoRequest,
              aerium.NetworkOuterClass.GetNodeInfoResponse>(
  ...
  private static abstract class NetworkBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return aerium.NetworkOuterClass.getDescriptor();
    }
