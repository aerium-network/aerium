...
const GetAccountResponse$json = {
  ...
  '2': [
    {'1': 'account', '3': 1, '4': 1, '5': 11, '6': '.aerium.AccountInfo', '10': 'account'},
  ],
};
...
final $typed_data.Uint8List getAccountResponseDescriptor = $convert.base64Decode(
    'ChJHZXRBY2NvdW50UmVzcG9uc2USLQoHYWNjb3VudBgBIAEoCzITLmFlcml1bS5BY2NvdW50SW'
    '5mb1IHYWNjb3VudA==');
...
const GetValidatorResponse$json = {
  ...
  '2': [
    {'1': 'validator', '3': 1, '4': 1, '5': 11, '6': '.aerium.ValidatorInfo', '10': 'validator'},
  ],
};
...
final $typed_data.Uint8List getValidatorResponseDescriptor = $convert.base64Decode(
    'ChRHZXRWYWxpZGF0b3JSZXNwb25zZRIzCgl2YWxpZGF0b3IYASABKAsyFS5hZXJpdW0uVmFsaW'
...
const GetBlockRequest$json = {
  ...
  '2': [
    ...
    {'1': 'verbosity', '3': 2, '4': 1, '5': 14, '6': '.aerium.BlockVerbosity', '10': 'verbosity'},
  ],
};
...
final $typed_data.Uint8List getBlockRequestDescriptor = $convert.base64Decode(
    ...
    'IgASgOMhYuYWVyaXVtLkJsb2NrVmVyYm9zaXR5Ugl2ZXJib3NpdHk=');
...
const GetBlockResponse$json = {
  ...
  '2': [
    ...
    {'1': 'header', '3': 5, '4': 1, '5': 11, '6': '.aerium.BlockHeaderInfo', '10': 'header'},
    {'1': 'prev_cert', '3': 6, '4': 1, '5': 11, '6': '.aerium.CertificateInfo', '10': 'prevCert'},
    {'1': 'txs', '3': 7, '4': 3, '5': 11, '6': '.aerium.TransactionInfo', '10': 'txs'},
  ],
};
...
final $typed_data.Uint8List getBlockResponseDescriptor = $convert.base64Decode(
    ...
    'bWUSLwoGaGVhZGVyGAUgASgLMhcuYWVyaXVtLkJsb2NrSGVhZGVySW5mb1IGaGVhZGVyEjQKCX'
    'ByZXZfY2VydBgGIAEoCzIXLmFlcml1bS5DZXJ0aWZpY2F0ZUluZm9SCHByZXZDZXJ0EikKA3R4'
    'cxgHIAMoCzIXLmFlcml1bS5UcmFuc2FjdGlvbkluZm9SA3R4cw==');
...
const GetBlockchainInfoResponse$json = {
  ...
  '2': [
    ...
    {'1': 'committee_validators', '3': 7, '4': 3, '5': 11, '6': '.aerium.ValidatorInfo', '10': 'committeeValidators'},
    ...
    {'1': 'committee_protocol_versions', '3': 11, '4': 3, '5': 11, '6': '.aerium.GetBlockchainInfoResponse.CommitteeProtocolVersionsEntry', '10': 'committeeProtocolVersions'},
  ],
...
final $typed_data.Uint8List getBlockchainInfoResponseDescriptor = $convert.base64Decode(
    ...
    'b3JzGAcgAygLMhUuYWVyaXVtLlZhbGlkYXRvckluZm9SE2NvbW1pdHRlZVZhbGlkYXRvcnMSGw'
    ...
    'NvbW1pdHRlZV9wcm90b2NvbF92ZXJzaW9ucxgLIAMoCzJALmFlcml1bS5HZXRCbG9ja2NoYWlu'
...
const GetConsensusInfoResponse$json = {
  ...
  '2': [
    {'1': 'proposal', '3': 1, '4': 1, '5': 11, '6': '.aerium.ProposalInfo', '10': 'proposal'},
    {'1': 'instances', '3': 2, '4': 3, '5': 11, '6': '.aerium.ConsensusInfo', '10': 'instances'},
  ],
};
...
final $typed_data.Uint8List getConsensusInfoResponseDescriptor = $convert.base64Decode(
    'ChhHZXRDb25zZW5zdXNJbmZvUmVzcG9uc2USMAoIcHJvcG9zYWwYASABKAsyFC5hZXJpdW0uUH'
    'JvcG9zYWxJbmZvUghwcm9wb3NhbBIzCglpbnN0YW5jZXMYAiADKAsyFS5hZXJpdW0uQ29uc2Vu'
...
const GetTxPoolContentRequest$json = {
  ...
  '2': [
    {'1': 'payload_type', '3': 1, '4': 1, '5': 14, '6': '.aerium.PayloadType', '10': 'payloadType'},
  ],
};
...
final $typed_data.Uint8List getTxPoolContentRequestDescriptor = $convert.base64Decode(
    'ChdHZXRUeFBvb2xDb250ZW50UmVxdWVzdBI2CgxwYXlsb2FkX3R5cGUYASABKA4yEy5hZXJpdW'
    '0uUGF5bG9hZFR5cGVSC3BheWxvYWRUeXBl');
...
const GetTxPoolContentResponse$json = {
  ...
  '2': [
    {'1': 'txs', '3': 1, '4': 3, '5': 11, '6': '.aerium.TransactionInfo', '10': 'txs'},
  ],
};
...
final $typed_data.Uint8List getTxPoolContentResponseDescriptor = $convert.base64Decode(
    'ChhHZXRUeFBvb2xDb250ZW50UmVzcG9uc2USKQoDdHhzGAEgAygLMhcuYWVyaXVtLlRyYW5zYW'
    'N0aW9uSW5mb1IDdHhz');
...
const VoteInfo$json = {
  '1': 'VoteInfo',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.aerium.VoteType', '10': 'type'},
...
final $typed_data.Uint8List voteInfoDescriptor = $convert.base64Decode(
    'CghWb3RlSW5mbxIkCgR0eXBlGAEgASgOMhAuYWVyaXVtLlZvdGVUeXBlUgR0eXBlEhQKBXZvdG'
...
const ConsensusInfo$json = {
  ...
  '2': [
    ...
    {'1': 'round', '3': 4, '4': 1, '5': 5, '10': 'round'},
    {'1': 'votes', '3': 5, '4': 3, '5': 11, '6': '.aerium.VoteInfo', '10': 'votes'},
  ],
};
...
final $typed_data.Uint8List consensusInfoDescriptor = $convert.base64Decode(
    ...
    'EiYKBXZvdGVzGAUgAygLMhAuYWVyaXVtLlZvdGVJbmZvUgV2b3Rlcw==');
...
const $core.Map<$core.String, $core.dynamic> BlockchainServiceBase$json = {
  '1': 'Blockchain',
  '2': [
    {'1': 'GetBlock', '2': '.aerium.GetBlockRequest', '3': '.aerium.GetBlockResponse'},
    {'1': 'GetBlockHash', '2': '.aerium.GetBlockHashRequest', '3': '.aerium.GetBlockHashResponse'},
    {'1': 'GetBlockHeight', '2': '.aerium.GetBlockHeightRequest', '3': '.aerium.GetBlockHeightResponse'},
    {'1': 'GetBlockchainInfo', '2': '.aerium.GetBlockchainInfoRequest', '3': '.aerium.GetBlockchainInfoResponse'},
    {'1': 'GetConsensusInfo', '2': '.aerium.GetConsensusInfoRequest', '3': '.aerium.GetConsensusInfoResponse'},
    {'1': 'GetAccount', '2': '.aerium.GetAccountRequest', '3': '.aerium.GetAccountResponse'},
    {'1': 'GetValidator', '2': '.aerium.GetValidatorRequest', '3': '.aerium.GetValidatorResponse'},
    {'1': 'GetValidatorByNumber', '2': '.aerium.GetValidatorByNumberRequest', '3': '.aerium.GetValidatorResponse'},
    {'1': 'GetValidatorAddresses', '2': '.aerium.GetValidatorAddressesRequest', '3': '.aerium.GetValidatorAddressesResponse'},
    {'1': 'GetPublicKey', '2': '.aerium.GetPublicKeyRequest', '3': '.aerium.GetPublicKeyResponse'},
    {'1': 'GetTxPoolContent', '2': '.aerium.GetTxPoolContentRequest', '3': '.aerium.GetTxPoolContentResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> BlockchainServiceBase$messageJson = {
  '.aerium.GetBlockRequest': GetBlockRequest$json,
  '.aerium.GetBlockResponse': GetBlockResponse$json,
  '.aerium.BlockHeaderInfo': BlockHeaderInfo$json,
  '.aerium.CertificateInfo': CertificateInfo$json,
  '.aerium.TransactionInfo': $0.TransactionInfo$json,
  '.aerium.PayloadTransfer': $0.PayloadTransfer$json,
  '.aerium.PayloadBond': $0.PayloadBond$json,
  '.aerium.PayloadSortition': $0.PayloadSortition$json,
  '.aerium.PayloadUnbond': $0.PayloadUnbond$json,
  '.aerium.PayloadWithdraw': $0.PayloadWithdraw$json,
  '.aerium.PayloadBatchTransfer': $0.PayloadBatchTransfer$json,
  '.aerium.Recipient': $0.Recipient$json,
  '.aerium.GetBlockHashRequest': GetBlockHashRequest$json,
  '.aerium.GetBlockHashResponse': GetBlockHashResponse$json,
  '.aerium.GetBlockHeightRequest': GetBlockHeightRequest$json,
  '.aerium.GetBlockHeightResponse': GetBlockHeightResponse$json,
  '.aerium.GetBlockchainInfoRequest': GetBlockchainInfoRequest$json,
  '.aerium.GetBlockchainInfoResponse': GetBlockchainInfoResponse$json,
  '.aerium.ValidatorInfo': ValidatorInfo$json,
  '.aerium.GetBlockchainInfoResponse.CommitteeProtocolVersionsEntry': GetBlockchainInfoResponse_CommitteeProtocolVersionsEntry$json,
  '.aerium.GetConsensusInfoRequest': GetConsensusInfoRequest$json,
  '.aerium.GetConsensusInfoResponse': GetConsensusInfoResponse$json,
  '.aerium.ProposalInfo': ProposalInfo$json,
  '.aerium.ConsensusInfo': ConsensusInfo$json,
  '.aerium.VoteInfo': VoteInfo$json,
  '.aerium.GetAccountRequest': GetAccountRequest$json,
  '.aerium.GetAccountResponse': GetAccountResponse$json,
  '.aerium.AccountInfo': AccountInfo$json,
  '.aerium.GetValidatorRequest': GetValidatorRequest$json,
  '.aerium.GetValidatorResponse': GetValidatorResponse$json,
  '.aerium.GetValidatorByNumberRequest': GetValidatorByNumberRequest$json,
  '.aerium.GetValidatorAddressesRequest': GetValidatorAddressesRequest$json,
  '.aerium.GetValidatorAddressesResponse': GetValidatorAddressesResponse$json,
  '.aerium.GetPublicKeyRequest': GetPublicKeyRequest$json,
  '.aerium.GetPublicKeyResponse': GetPublicKeyResponse$json,
  '.aerium.GetTxPoolContentRequest': GetTxPoolContentRequest$json,
  '.aerium.GetTxPoolContentResponse': GetTxPoolContentResponse$json,
};
...
final $typed_data.Uint8List blockchainServiceDescriptor = $convert.base64Decode(
    'CgpCbG9ja2NoYWluEj0KCEdldEJsb2NrEhcuYWVyaXVtLkdldEJsb2NrUmVxdWVzdBoYLmFlcm'
    'l1bS5HZXRCbG9ja1Jlc3BvbnNlEkkKDEdldEJsb2NrSGFzaBIbLmFlcml1bS5HZXRCbG9ja0hh'
    'c2hSZXF1ZXN0GhwuYWVyaXVtLkdldEJsb2NrSGFzaFJlc3BvbnNlEk8KDkdldEJsb2NrSGVpZ2'
    'h0Eh0uYWVyaXVtLkdldEJsb2NrSGVpZ2h0UmVxdWVzdBoeLmFlcml1bS5HZXRCbG9ja0hlaWdo'
    'dFJlc3BvbnNlElgKEUdldEJsb2NrY2hhaW5JbmZvEiAuYWVyaXVtLkdldEJsb2NrY2hhaW5Jbm'
    'ZvUmVxdWVzdBohLmFlcml1bS5HZXRCbG9ja2NoYWluSW5mb1Jlc3BvbnNlElUKEEdldENvbnNl'
    'bnN1c0luZm8SHy5hZXJpdW0uR2V0Q29uc2Vuc3VzSW5mb1JlcXVlc3QaIC5hZXJpdW0uR2V0Q2'
    '9uc2Vuc3VzSW5mb1Jlc3BvbnNlEkMKCkdldEFjY291bnQSGS5hZXJpdW0uR2V0QWNjb3VudFJl'
    'cXVlc3QaGi5hZXJpdW0uR2V0QWNjb3VudFJlc3BvbnNlEkkKDEdldFZhbGlkYXRvchIbLmFlcm'
    'l1bS5HZXRWYWxpZGF0b3JSZXF1ZXN0GhwuYWVyaXVtLkdldFZhbGlkYXRvclJlc3BvbnNlElkK'
    'FEdldFZhbGlkYXRvckJ5TnVtYmVyEiMuYWVyaXVtLkdldFZhbGlkYXRvckJ5TnVtYmVyUmVxdW'
    'VzdBocLmFlcml1bS5HZXRWYWxpZGF0b3JSZXNwb25zZRJkChVHZXRWYWxpZGF0b3JBZGRyZXNz'
    'ZXMSJC5hZXJpdW0uR2V0VmFsaWRhdG9yQWRkcmVzc2VzUmVxdWVzdBolLmFlcml1bS5HZXRWYW'
    'xpZGF0b3JBZGRyZXNzZXNSZXNwb25zZRJJCgxHZXRQdWJsaWNLZXkSGy5hZXJpdW0uR2V0UHVi'
    'bGljS2V5UmVxdWVzdBocLmFlcml1bS5HZXRQdWJsaWNLZXlSZXNwb25zZRJVChBHZXRUeFBvb2'
    'xDb250ZW50Eh8uYWVyaXVtLkdldFR4UG9vbENvbnRlbnRSZXF1ZXN0GiAuYWVyaXVtLkdldFR4'
