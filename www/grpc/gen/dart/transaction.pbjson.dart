...
const GetTransactionRequest$json = {
  ...
  '2': [
    ...
    {'1': 'verbosity', '3': 2, '4': 1, '5': 14, '6': '.aerium.TransactionVerbosity', '10': 'verbosity'},
  ],
};
...
final $typed_data.Uint8List getTransactionRequestDescriptor = $convert.base64Decode(
    ...
    'EoDjIcLmFlcml1bS5UcmFuc2FjdGlvblZlcmJvc2l0eVIJdmVyYm9zaXR5');
...
const GetTransactionResponse$json = {
  ...
  '2': [
    ...
    {'1': 'transaction', '3': 3, '4': 1, '5': 11, '6': '.aerium.TransactionInfo', '10': 'transaction'},
  ],
};
...
final $typed_data.Uint8List getTransactionResponseDescriptor = $convert.base64Decode(
    ...
    'MhcuYWVyaXVtLlRyYW5zYWN0aW9uSW5mb1ILdHJhbnNhY3Rpb24=');
...
const CalculateFeeRequest$json = {
  ...
  '2': [
    ...
    {'1': 'payload_type', '3': 2, '4': 1, '5': 14, '6': '.aerium.PayloadType', '10': 'payloadType'},
...
final $typed_data.Uint8List calculateFeeRequestDescriptor = $convert.base64Decode(
    ...
    'RfdHlwZRgCIAEoDjITLmFlcml1bS5QYXlsb2FkVHlwZVILcGF5bG9hZFR5cGUSIQoMZml4ZWRf'
...
const GetRawBatchTransferTransactionRequest$json = {
  ...
  '2': [
    {'1': 'lock_time', '3': 1, '4': 1, '5': 13, '10': 'lockTime'},
    {'1': 'sender', '3': 2, '4': 1, '5': 9, '10': 'sender'},
    {'1': 'recipients', '3': 3, '4': 3, '5': 11, '6': '.aerium.Recipient', '10': 'recipients'},
...
final $typed_data.Uint8List getRawBatchTransferTransactionRequestDescriptor = $convert.base64Decode(
    ...
    'CzIRLmFlcml1bS5SZWNpcGllbnRSCnJlY2lwaWVudHMSEAoDZmVlGAQgASgDUgNmZWUSEgoEbW'
...
const PayloadBatchTransfer$json = {
  ...
  '2': [
    {'1': 'sender', '3': 1, '4': 1, '5': 9, '10': 'sender'},
    {'1': 'recipients', '3': 2, '4': 3, '5': 11, '6': '.aerium.Recipient', '10': 'recipients'},
  ],
};
...
final $typed_data.Uint8List payloadBatchTransferDescriptor = $convert.base64Decode(
    ...
    'llbnRzGAIgAygLMhEuYWVyaXVtLlJlY2lwaWVudFIKcmVjaXBpZW50cw==');
...
const TransactionInfo$json = {
  ...
  '2': [
    ...
    {'1': 'fee', '3': 6, '4': 1, '5': 3, '10': 'fee'},
    {'1': 'payload_type', '3': 7, '4': 1, '5': 14, '6': '.aerium.PayloadType', '10': 'payloadType'},
    {'1': 'transfer', '3': 30, '4': 1, '5': 11, '6': '.aerium.PayloadTransfer', '9': 0, '10': 'transfer'},
    {'1': 'bond', '3': 31, '4': 1, '5': 11, '6': '.aerium.PayloadBond', '9': 0, '10': 'bond'},
    {'1': 'sortition', '3': 32, '4': 1, '5': 11, '6': '.aerium.PayloadSortition', '9': 0, '10': 'sortition'},
    {'1': 'unbond', '3': 33, '4': 1, '5': 11, '6': '.aerium.PayloadUnbond', '9': 0, '10': 'unbond'},
    {'1': 'withdraw', '3': 34, '4': 1, '5': 11, '6': '.aerium.PayloadWithdraw', '9': 0, '10': 'withdraw'},
    {'1': 'batch_transfer', '3': 35, '4': 1, '5': 11, '6': '.aerium.PayloadBatchTransfer', '9': 0, '10': 'batchTransfer'},
...
final $typed_data.Uint8List transactionInfoDescriptor = $convert.base64Decode(
    ...
    'ABKA4yEy5hZXJpdW0uUGF5bG9hZFR5cGVSC3BheWxvYWRUeXBlEjUKCHRyYW5zZmVyGB4gASgL'
    'MhcuYWVyaXVtLlBheWxvYWRUcmFuc2ZlckgAUgh0cmFuc2ZlchIpCgRib25kGB8gASgLMhMuYW'
    'VyaXVtLlBheWxvYWRCb25kSABSBGJvbmQSOAoJc29ydGl0aW9uGCAgASgLMhguYWVyaXVtLlBh'
    'eWxvYWRTb3J0aXRpb25IAFIJc29ydGl0aW9uEi8KBnVuYm9uZBghIAEoCzIVLmFlcml1bS5QYX'
    'lsb2FkVW5ib25kSABSBnVuYm9uZBI1Cgh3aXRoZHJhdxgiIAEoCzIXLmFlcml1bS5QYXlsb2Fk'
    'V2l0aGRyYXdIAFIId2l0aGRyYXcSRQoOYmF0Y2hfdHJhbnNmZXIYIyABKAsyHC5hZXJpdW0uUG'
...
const DecodeRawTransactionResponse$json = {
  ...
  '2': [
    {'1': 'transaction', '3': 1, '4': 1, '5': 11, '6': '.aerium.TransactionInfo', '10': 'transaction'},
  ],
};
...
final $typed_data.Uint8List decodeRawTransactionResponseDescriptor = $convert.base64Decode(
    'ChxEZWNvZGVSYXdUcmFuc2FjdGlvblJlc3BvbnNlEjkKC3RyYW5zYWN0aW9uGAEgASgLMhcuYW'
    'VyaXVtLlRyYW5zYWN0aW9uSW5mb1ILdHJhbnNhY3Rpb24=');

const $core.Map<$core.String, $core.dynamic> TransactionServiceBase$json = {
  '1': 'Transaction',
  '2': [
    {'1': 'GetTransaction', '2': '.aerium.GetTransactionRequest', '3': '.aerium.GetTransactionResponse'},
    {'1': 'CalculateFee', '2': '.aerium.CalculateFeeRequest', '3': '.aerium.CalculateFeeResponse'},
    {'1': 'BroadcastTransaction', '2': '.aerium.BroadcastTransactionRequest', '3': '.aerium.BroadcastTransactionResponse'},
    {'1': 'GetRawTransferTransaction', '2': '.aerium.GetRawTransferTransactionRequest', '3': '.aerium.GetRawTransactionResponse'},
    {'1': 'GetRawBondTransaction', '2': '.aerium.GetRawBondTransactionRequest', '3': '.aerium.GetRawTransactionResponse'},
    {'1': 'GetRawUnbondTransaction', '2': '.aerium.GetRawUnbondTransactionRequest', '3': '.aerium.GetRawTransactionResponse'},
    {'1': 'GetRawWithdrawTransaction', '2': '.aerium.GetRawWithdrawTransactionRequest', '3': '.aerium.GetRawTransactionResponse'},
    {'1': 'GetRawBatchTransferTransaction', '2': '.aerium.GetRawBatchTransferTransactionRequest', '3': '.aerium.GetRawTransactionResponse'},
    {'1': 'DecodeRawTransaction', '2': '.aerium.DecodeRawTransactionRequest', '3': '.aerium.DecodeRawTransactionResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> TransactionServiceBase$messageJson = {
  '.aerium.GetTransactionRequest': GetTransactionRequest$json,
  '.aerium.GetTransactionResponse': GetTransactionResponse$json,
  '.aerium.TransactionInfo': TransactionInfo$json,
  '.aerium.PayloadTransfer': PayloadTransfer$json,
  '.aerium.PayloadBond': PayloadBond$json,
  '.aerium.PayloadSortition': PayloadSortition$json,
  '.aerium.PayloadUnbond': PayloadUnbond$json,
  '.aerium.PayloadWithdraw': PayloadWithdraw$json,
  '.aerium.PayloadBatchTransfer': PayloadBatchTransfer$json,
  '.aerium.Recipient': Recipient$json,
  '.aerium.CalculateFeeRequest': CalculateFeeRequest$json,
  '.aerium.CalculateFeeResponse': CalculateFeeResponse$json,
  '.aerium.BroadcastTransactionRequest': BroadcastTransactionRequest$json,
  '.aerium.BroadcastTransactionResponse': BroadcastTransactionResponse$json,
  '.aerium.GetRawTransferTransactionRequest': GetRawTransferTransactionRequest$json,
  '.aerium.GetRawTransactionResponse': GetRawTransactionResponse$json,
  '.aerium.GetRawBondTransactionRequest': GetRawBondTransactionRequest$json,
  '.aerium.GetRawUnbondTransactionRequest': GetRawUnbondTransactionRequest$json,
  '.aerium.GetRawWithdrawTransactionRequest': GetRawWithdrawTransactionRequest$json,
  '.aerium.GetRawBatchTransferTransactionRequest': GetRawBatchTransferTransactionRequest$json,
  '.aerium.DecodeRawTransactionRequest': DecodeRawTransactionRequest$json,
  '.aerium.DecodeRawTransactionResponse': DecodeRawTransactionResponse$json,
};
...
final $typed_data.Uint8List transactionServiceDescriptor = $convert.base64Decode(
    'CgtUcmFuc2FjdGlvbhJPCg5HZXRUcmFuc2FjdGlvbhIdLmFlcml1bS5HZXRUcmFuc2FjdGlvbl'
    'JlcXVlc3QaHi5hZXJpdW0uR2V0VHJhbnNhY3Rpb25SZXNwb25zZRJJCgxDYWxjdWxhdGVGZWUS'
    'Gy5hZXJpdW0uQ2FsY3VsYXRlRmVlUmVxdWVzdBocLmFlcml1bS5DYWxjdWxhdGVGZWVSZXNwb2'
    '5zZRJhChRCcm9hZGNhc3RUcmFuc2FjdGlvbhIjLmFlcml1bS5Ccm9hZGNhc3RUcmFuc2FjdGlv'
    'blJlcXVlc3QaJC5hZXJpdW0uQnJvYWRjYXN0VHJhbnNhY3Rpb25SZXNwb25zZRJoChlHZXRSYX'
    'dUcmFuc2ZlclRyYW5zYWN0aW9uEiguYWVyaXVtLkdldFJhd1RyYW5zZmVyVHJhbnNhY3Rpb25S'
    'ZXF1ZXN0GiEuYWVyaXVtLkdldFJhd1RyYW5zYWN0aW9uUmVzcG9uc2USYAoVR2V0UmF3Qm9uZF'
    'RyYW5zYWN0aW9uEiQuYWVyaXVtLkdldFJhd0JvbmRUcmFuc2FjdGlvblJlcXVlc3QaIS5hZXJp'
    'dW0uR2V0UmF3VHJhbnNhY3Rpb25SZXNwb25zZRJkChdHZXRSYXdVbmJvbmRUcmFuc2FjdGlvbh'
    'ImLmFlcml1bS5HZXRSYXdVbmJvbmRUcmFuc2FjdGlvblJlcXVlc3QaIS5hZXJpdW0uR2V0UmF3'
    'VHJhbnNhY3Rpb25SZXNwb25zZRJoChlHZXRSYXdXaXRoZHJhd1RyYW5zYWN0aW9uEiguYWVyaX'
    'VtLkdldFJhd1dpdGhkcmF3VHJhbnNhY3Rpb25SZXF1ZXN0GiEuYWVyaXVtLkdldFJhd1RyYW5z'
    'YWN0aW9uUmVzcG9uc2UScgoeR2V0UmF3QmF0Y2hUcmFuc2ZlclRyYW5zYWN0aW9uEi0uYWVyaX'
    'VtLkdldFJhd0JhdGNoVHJhbnNmZXJUcmFuc2FjdGlvblJlcXVlc3QaIS5hZXJpdW0uR2V0UmF3'
    'VHJhbnNhY3Rpb25SZXNwb25zZRJhChREZWNvZGVSYXdUcmFuc2FjdGlvbhIjLmFlcml1bS5EZW'
    'NvZGVSYXdUcmFuc2FjdGlvblJlcXVlc3QaJC5hZXJpdW0uRGVjb2RlUmF3VHJhbnNhY3Rpb25S'
    'ZXNwb25zZQ==');
