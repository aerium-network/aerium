...
const $core.Map<$core.String, $core.dynamic> UtilsServiceBase$json = {
  '1': 'Utils',
  '2': [
    {'1': 'SignMessageWithPrivateKey', '2': '.aerium.SignMessageWithPrivateKeyRequest', '3': '.aerium.SignMessageWithPrivateKeyResponse'},
    {'1': 'VerifyMessage', '2': '.aerium.VerifyMessageRequest', '3': '.aerium.VerifyMessageResponse'},
    {'1': 'PublicKeyAggregation', '2': '.aerium.PublicKeyAggregationRequest', '3': '.aerium.PublicKeyAggregationResponse'},
    {'1': 'SignatureAggregation', '2': '.aerium.SignatureAggregationRequest', '3': '.aerium.SignatureAggregationResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> UtilsServiceBase$messageJson = {
  '.aerium.SignMessageWithPrivateKeyRequest': SignMessageWithPrivateKeyRequest$json,
  '.aerium.SignMessageWithPrivateKeyResponse': SignMessageWithPrivateKeyResponse$json,
  '.aerium.VerifyMessageRequest': VerifyMessageRequest$json,
  '.aerium.VerifyMessageResponse': VerifyMessageResponse$json,
  '.aerium.PublicKeyAggregationRequest': PublicKeyAggregationRequest$json,
  '.aerium.PublicKeyAggregationResponse': PublicKeyAggregationResponse$json,
  '.aerium.SignatureAggregationRequest': SignatureAggregationRequest$json,
  '.aerium.SignatureAggregationResponse': SignatureAggregationResponse$json,
};
...
final $typed_data.Uint8List utilsServiceDescriptor = $convert.base64Decode(
    'CgVVdGlscxJwChlTaWduTWVzc2FnZVdpdGhQcml2YXRlS2V5EiguYWVyaXVtLlNpZ25NZXNzYW'
    'dlV2l0aFByaXZhdGVLZXlSZXF1ZXN0GikuYWVyaXVtLlNpZ25NZXNzYWdlV2l0aFByaXZhdGVL'
    'ZXlSZXNwb25zZRJMCg1WZXJpZnlNZXNzYWdlEhwuYWVyaXVtLlZlcmlmeU1lc3NhZ2VSZXF1ZX'
    'N0Gh0uYWVyaXVtLlZlcmlmeU1lc3NhZ2VSZXNwb25zZRJhChRQdWJsaWNLZXlBZ2dyZWdhdGlv'
    'bhIjLmFlcml1bS5QdWJsaWNLZXlBZ2dyZWdhdGlvblJlcXVlc3QaJC5hZXJpdW0uUHVibGljS2'
    'V5QWdncmVnYXRpb25SZXNwb25zZRJhChRTaWduYXR1cmVBZ2dyZWdhdGlvbhIjLmFlcml1bS5T'
    'aWduYXR1cmVBZ2dyZWdhdGlvblJlcXVlc3QaJC5hZXJpdW0uU2lnbmF0dXJlQWdncmVnYXRpb2'
    '5SZXNwb25zZQ==');
