...
- <i class="fa-brands fa-js"></i> [aerium-grpc](https://www.npmjs.com/package/aerium-grpc/) package for Javascript
- <i class="fa-brands fa-python"></i> [aerium-grpc](https://pypi.org/project/aerium-grpc/) package for Python
- <i class="fa-brands fa-rust"></i> [aerium-grpc](https://crates.io/crates/aerium-grpc) package for Rust
...
<div id="toc-container">
  ...
  <li> Transaction Service
      <ul>
        <li>
          <a href="#aerium.Transaction.GetTransaction">
          <span class="rpc-badge"></span> GetTransaction</a>
        </li>
        <li>
          <a href="#aerium.Transaction.CalculateFee">
          <span class="rpc-badge"></span> CalculateFee</a>
        </li>
        <li>
          <a href="#aerium.Transaction.BroadcastTransaction">
          <span class="rpc-badge"></span> BroadcastTransaction</a>
        </li>
        <li>
          <a href="#aerium.Transaction.GetRawTransferTransaction">
          <span class="rpc-badge"></span> GetRawTransferTransaction</a>
        </li>
        <li>
          <a href="#aerium.Transaction.GetRawBondTransaction">
          <span class="rpc-badge"></span> GetRawBondTransaction</a>
        </li>
        <li>
          <a href="#aerium.Transaction.GetRawUnbondTransaction">
          <span class="rpc-badge"></span> GetRawUnbondTransaction</a>
        </li>
        <li>
          <a href="#aerium.Transaction.GetRawWithdrawTransaction">
          <span class="rpc-badge"></span> GetRawWithdrawTransaction</a>
        </li>
        <li>
          <a href="#aerium.Transaction.GetRawBatchTransferTransaction">
          <span class="rpc-badge"></span> GetRawBatchTransferTransaction</a>
        </li>
        <li>
          <a href="#aerium.Transaction.DecodeRawTransaction">
    ...
    <li> Blockchain Service
      <ul>
        <li>
          <a href="#aerium.Blockchain.GetBlock">
          <span class="rpc-badge"></span> GetBlock</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetBlockHash">
          <span class="rpc-badge"></span> GetBlockHash</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetBlockHeight">
          <span class="rpc-badge"></span> GetBlockHeight</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetBlockchainInfo">
          <span class="rpc-badge"></span> GetBlockchainInfo</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetConsensusInfo">
          <span class="rpc-badge"></span> GetConsensusInfo</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetAccount">
          <span class="rpc-badge"></span> GetAccount</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetValidator">
          <span class="rpc-badge"></span> GetValidator</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetValidatorByNumber">
          <span class="rpc-badge"></span> GetValidatorByNumber</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetValidatorAddresses">
          <span class="rpc-badge"></span> GetValidatorAddresses</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetPublicKey">
          <span class="rpc-badge"></span> GetPublicKey</a>
        </li>
        <li>
          <a href="#aerium.Blockchain.GetTxPoolContent">
    ...
    <li> Network Service
      <ul>
        <li>
          <a href="#aerium.Network.GetNetworkInfo">
          <span class="rpc-badge"></span> GetNetworkInfo</a>
        </li>
        <li>
          <a href="#aerium.Network.GetNodeInfo">
    ...
    <li> Utils Service
      <ul>
        <li>
          <a href="#aerium.Utils.SignMessageWithPrivateKey">
          <span class="rpc-badge"></span> SignMessageWithPrivateKey</a>
        </li>
        <li>
          <a href="#aerium.Utils.VerifyMessage">
          <span class="rpc-badge"></span> VerifyMessage</a>
        </li>
        <li>
          <a href="#aerium.Utils.PublicKeyAggregation">
          <span class="rpc-badge"></span> PublicKeyAggregation</a>
        </li>
        <li>
          <a href="#aerium.Utils.SignatureAggregation">
