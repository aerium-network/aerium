...
func TestGetBlock(t *testing.T) {
	...
	t.Run("Should return nil for non existing block ", func(t *testing.T) {
		res, err := client.GetBlock(context.Background(),
			&aerium.GetBlockRequest{
				Height: height + 1, Verbosity: aerium.BlockVerbosity_BLOCK_VERBOSITY_DATA,
			})
	...
	t.Run("Should return an existing block data (verbosity: 0)", func(t *testing.T) {
		res, err := client.GetBlock(context.Background(),
			&aerium.GetBlockRequest{Height: height, Verbosity: aerium.BlockVerbosity_BLOCK_VERBOSITY_DATA})
	...
	t.Run("Should return object with (verbosity: 1)", func(t *testing.T) {
		res, err := client.GetBlock(context.Background(),
			&aerium.GetBlockRequest{Height: height, Verbosity: aerium.BlockVerbosity_BLOCK_VERBOSITY_INFO})
	...
	t.Run("Should return object with (verbosity: 2)", func(t *testing.T) {
		res, err := client.GetBlock(context.Background(),
			&aerium.GetBlockRequest{Height: height, Verbosity: aerium.BlockVerbosity_BLOCK_VERBOSITY_TRANSACTIONS})
...
func TestGetBlockHash(t *testing.T) {
	...
	t.Run("Should return error for non existing block", func(t *testing.T) {
		res, err := client.GetBlockHash(context.Background(),
			&aerium.GetBlockHashRequest{Height: 0})
	...
	t.Run("Should return height of existing block", func(t *testing.T) {
		res, err := client.GetBlockHash(context.Background(),
			&aerium.GetBlockHashRequest{Height: height})
...
func TestGetBlockHeight(t *testing.T) {
	...
	t.Run("Should return error for invalid hash", func(t *testing.T) {
		res, err := client.GetBlockHeight(context.Background(),
			&aerium.GetBlockHeightRequest{Hash: ""})
	...
	t.Run("Should return error for non existing block", func(t *testing.T) {
		res, err := client.GetBlockHeight(context.Background(),
			&aerium.GetBlockHeightRequest{Hash: td.RandHash().String()})
	...
	t.Run("Should return height of existing block", func(t *testing.T) {
		res, err := client.GetBlockHeight(context.Background(),
			&aerium.GetBlockHeightRequest{Hash: blk.Hash().String()})
...
func TestGetAccount(t *testing.T) {
	...
	t.Run("Should return error for non-parsable address ", func(t *testing.T) {
		res, err := client.GetAccount(context.Background(),
			&aerium.GetAccountRequest{Address: ""})
	...
	t.Run("Should return nil for non existing account ", func(t *testing.T) {
		res, err := client.GetAccount(context.Background(),
			&aerium.GetAccountRequest{Address: td.RandAccAddress().String()})
	...
	t.Run("Should return account details", func(t *testing.T) {
		...
		assert.Nil(t, err)
		assert.NotNil(t, res)
		assert.Equal(t, acc.Balance().ToNanoAUM(), res.Account.Balance)
...
func TestGetValidator(t *testing.T) {
	...
	t.Run("Should return nil value due to invalid address", func(t *testing.T) {
		res, err := client.GetValidator(context.Background(),
			&aerium.GetValidatorRequest{Address: ""})
	...
	t.Run("should return Not Found", func(t *testing.T) {
		res, err := client.GetValidator(context.Background(),
			&aerium.GetValidatorRequest{Address: td.RandAccAddress().String()})
	...
	t.Run("Should return validator, and the public keys should match", func(t *testing.T) {
		res, err := client.GetValidator(context.Background(),
			&aerium.GetValidatorRequest{Address: val1.Address().String()})
...
func TestGetValidatorByNumber(t *testing.T) {
	...
	t.Run("Should return nil value due to invalid number", func(t *testing.T) {
		res, err := client.GetValidatorByNumber(context.Background(),
			&aerium.GetValidatorByNumberRequest{Number: -1})
	...
	t.Run("should return Not Found", func(t *testing.T) {
		res, err := client.GetValidatorByNumber(context.Background(),
			&aerium.GetValidatorByNumberRequest{Number: val1.Number() + 1})
	...
	t.Run("Should return validator matching with public key and number", func(t *testing.T) {
		res, err := client.GetValidatorByNumber(context.Background(),
			&aerium.GetValidatorByNumberRequest{Number: val1.Number()})
...
func TestGetValidatorAddresses(t *testing.T) {
	...
	t.Run("should return list of validator addresses", func(t *testing.T) {
		...
		res, err := client.GetValidatorAddresses(context.Background(),
			&aerium.GetValidatorAddressesRequest{})
...
func TestGetPublicKey(t *testing.T) {
	...
	t.Run("Should return error for non-parsable address ", func(t *testing.T) {
		res, err := client.GetPublicKey(context.Background(),
			&aerium.GetPublicKeyRequest{Address: ""})
	...
	t.Run("Should return nil for non existing public key ", func(t *testing.T) {
		res, err := client.GetPublicKey(context.Background(),
			&aerium.GetPublicKeyRequest{Address: td.RandAccAddress().String()})
	...
	t.Run("Should return the public key", func(t *testing.T) {
		res, err := client.GetPublicKey(context.Background(),
			&aerium.GetPublicKeyRequest{Address: val.Address().String()})
...
func TestConsensusInfo(t *testing.T) {
	...
	t.Run("Should return the consensus info", func(t *testing.T) {
		res, err := client.GetConsensusInfo(context.Background(), &aerium.GetConsensusInfoRequest{})
		...
		assert.Equal(t, aerium.VoteType_VOTE_TYPE_PREPARE, res.Instances[0].Votes[0].Type)
		assert.Equal(t, aerium.VoteType_VOTE_TYPE_PRECOMMIT, res.Instances[0].Votes[1].Type)
...
func TestGetTxPoolContent(t *testing.T) {
	...
	t.Run("Should return all transactions", func(t *testing.T) {
		in := &aerium.GetTxPoolContentRequest{
			PayloadType: aerium.PayloadType_PAYLOAD_TYPE_UNSPECIFIED,
		}
	...
	t.Run("Should return all Bond transactions", func(t *testing.T) {
		in := &aerium.GetTxPoolContentRequest{
			PayloadType: aerium.PayloadType_PAYLOAD_TYPE_BOND,
		}
		resp, err := client.GetTxPoolContent(context.Background(), in)
		...
		for _, tx := range resp.Txs {
			assert.Equal(t, aerium.PayloadType_PAYLOAD_TYPE_BOND, tx.PayloadType)
		}
	})

	t.Run("Should return all Transfer transactions", func(t *testing.T) {
		in := &aerium.GetTxPoolContentRequest{
			PayloadType: aerium.PayloadType_PAYLOAD_TYPE_TRANSFER,
		}
		resp, err := client.GetTxPoolContent(context.Background(), in)
		...
		for _, tx := range resp.Txs {
			assert.Equal(t, aerium.PayloadType_PAYLOAD_TYPE_TRANSFER, tx.PayloadType)
		}
	})

	t.Run("Should return all Unbond transactions", func(t *testing.T) {
		in := &aerium.GetTxPoolContentRequest{
			PayloadType: aerium.PayloadType_PAYLOAD_TYPE_UNBOND,
		}
		resp, err := client.GetTxPoolContent(context.Background(), in)
		...
		for _, tx := range resp.Txs {
			assert.Equal(t, aerium.PayloadType_PAYLOAD_TYPE_UNBOND, tx.PayloadType)
		}
	})

	t.Run("Should return all Sortition transactions", func(t *testing.T) {
		in := &aerium.GetTxPoolContentRequest{
			PayloadType: aerium.PayloadType_PAYLOAD_TYPE_SORTITION,
		}
		resp, err := client.GetTxPoolContent(context.Background(), in)
		...
		for _, tx := range resp.Txs {
			assert.Equal(t, aerium.PayloadType_PAYLOAD_TYPE_SORTITION, tx.PayloadType)
		}
	})

	t.Run("Should return all Withdraw transactions", func(t *testing.T) {
		in := &aerium.GetTxPoolContentRequest{
			PayloadType: aerium.PayloadType_PAYLOAD_TYPE_WITHDRAW,
		}
		resp, err := client.GetTxPoolContent(context.Background(), in)
		...
		for _, tx := range resp.Txs {
			assert.Equal(t, aerium.PayloadType_PAYLOAD_TYPE_WITHDRAW, tx.PayloadType)
		}
	})
