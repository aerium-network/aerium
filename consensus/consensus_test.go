...
func (td *testData) addPrecommitVote(t *testing.T, cons *consensus, blockHash hash.Hash,
...
func (td *testData) addCPPreVote(t *testing.T, cons *consensus, blockHash hash.Hash,
...
func (td *testData) addCPMainVote(t *testing.T, cons *consensus, blockHash hash.Hash,
	height uint32, round int16, cpVal vote.CPValue, just vote.Just, valID int,
) *vote.Vote {
	t.Helper()
...
func (td *testData) addCPDecidedVote(t *testing.T, cons *consensus, blockHash hash.Hash, height uint32, round int16,
...
func (td *testData) addVote(t *testing.T, cons *consensus, vote *vote.Vote, valID int) *vote.Vote {
	t.Helper()
...
func (*testData) queryVoteTimeout(cons *consensus) {
	cons.lk.Lock()
