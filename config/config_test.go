...
func TestMainnetConfig(t *testing.T) {
	...
	assert.NoError(t, conf.BasicCheck())
	assert.Empty(t, conf.Network.ListenAddrStrings)
	assert.Equal(t, "aerium", conf.Network.NetworkName)
	assert.Equal(t, 19933, conf.Network.DefaultPort)
...
func TestTestnetConfig(t *testing.T) {
	...
	assert.NoError(t, conf.BasicCheck())
	assert.Empty(t, conf.Network.ListenAddrStrings)
	assert.Equal(t, "aerium-testnet", conf.Network.NetworkName)
	assert.Equal(t, 19944, conf.Network.DefaultPort)
...
func TestLocalnetConfig(t *testing.T) {
	...
	assert.NoError(t, conf.BasicCheck())
	assert.Empty(t, conf.Network.ListenAddrStrings)
	assert.Equal(t, "aerium-localnet", conf.Network.NetworkName)
