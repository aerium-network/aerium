...
func TestCreateRootCommand(t *testing.T) {
	...
	require.Equal(t, "Aerium Shell", rootCmd.Short)
	require.Contains(t, rootCmd.Long, "aerium-shell is a command line tool")
	...
	require.Equal(t, "Start aerium-shell in interactive mode", interactiveCmd.Short)
