...
import (
	...
	"github.com/aerium-network/aerium/util/downloader"
...
func startupAssistant(workingDir string, chainType genesis.ChainType) bool {
	...
	assistant.SetTitle("Aerium - Init Wizard")
...
Offline data is available at: <a href="https://snapshot.aerium.dev">https://snapshot.aerium.dev</a>.`
...
For more information, look <a href="https://aerium.dev/user-guides/run-aerium-gui/">here</a>`
