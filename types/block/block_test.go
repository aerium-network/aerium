...
func TestBasicCheck(t *testing.T) {
	...
	t.Run("Invalid proposer address (type is 2)", func(t *testing.T) {
		...
		err := blk.BasicCheck()
		assert.ErrorIs(t, err, block.BasicCheckError{
			Reason: "invalid proposer address: ae1z42424242424242424242424242424242649ngh",
		})
	})
...
func TestMakeBlock(t *testing.T) {
	...
	blk1 := block.MakeBlock(protocol.ProtocolVersion1, blk0.Header().Time(), blk0.Transactions(),
