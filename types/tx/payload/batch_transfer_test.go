...
func TestBatchTransferDecoding(t *testing.T) {
	...
	for no, tt := range tests {
		t.Run(fmt.Sprintf("%d", no), func(t *testing.T) {
			pld := BatchTransferPayload{}
