...
var (
	...
	tBlockchainClient  aerium.BlockchainClient
	tTransactionClient aerium.TransactionClient
	tNetwork           aerium.NetworkClient
...
func TestMain(m *testing.M) {
	...
	tBlockchainClient = aerium.NewBlockchainClient(grpcConn)
	tTransactionClient = aerium.NewTransactionClient(grpcConn)
	tNetwork = aerium.NewNetworkClient(grpcConn)
