...
func TestSigning(t *testing.T) {
	...
	sig, _ := bls.SignatureFromString(
		"b84f476cb5114560056a110db2951f5a0eb2efb2830e684779b9697d70736add77b8fcc2debd0f0b1f953e589d2f7646")
	addr, _ := crypto.AddressFromString("ae1p5x2a0lkt5nrrdqe0rkcv6r4pfkmdhrr32u6erz")
...
func TestSignatureAggregate(t *testing.T) {
	...
	agg, _ := bls.SignatureFromString(
		"a464e0e735201a5fb7c92f4698f68c8ca17d6cbd49f160bca475db21ec3101fb3b555ae83d1c4dd4b263b9f710749305")
