...
import (
	...
	"github.com/aerium-network/aerium/util/bech32m"
...
func TestAddressType(t *testing.T) {
	tests := []struct {
		...
		{address: "ae1pm3cgmrqwqzl9py4dmkm24rt70vm7qn7qhw7hgp", account: false, validator: true},
		{address: "ae1z3uma3m36m6gc7s00525a453qqmksugde886num", account: true, validator: false},
		{address: "ae1rm7qg48aesj07jprpeqtt29mzy8dzy3sq2ja4u6", account: true, validator: false},
	}
...
func TestFromString(t *testing.T) {
	tests := []struct {
		...
		{
			"ae19p72rf",
			bech32m.InvalidChecksumError{Expected: "sx5tqr", Actual: "9p72rf"},
			nil,
			0,
		},
		{
		...
		{
			"ae1pm3cgmrqwqzl9py4dmkm24rt70vm7qn7g8xaf5",
			bech32m.InvalidChecksumError{Expected: "7w9ny7", Actual: "g8xaf5"},
			nil,
			0,
		},
		{
			"ae1y0hrct7eflrpw4ccrttxzs4qud2axex4d66lt30",
			crypto.InvalidAddressTypeError(4),
			nil,
			0,
		},
		{
			"AE1P0HRCT7EFLRPW4CCRTTXZS4QUD2AXEX4D58X9PP", // UPPERCASE
			nil,
			[]byte{
		...
		{
			"ae1p0hrct7eflrpw4ccrttxzs4qud2axex4d58x9pp",
			nil,
			[]byte{
				0x01, 0x7d, 0xc7, 0x85, 0xfb, 0x29, 0xf8, 0xc2, 0xea, 0xe3,
				0x03, 0x5a, 0xcc, 0x28, 0x54, 0x1c, 0x6a, 0xba, 0x6c, 0x9a, 0xad,
		...
		{
			"ae1zzqkzzu4vyddss052as6c37qrdcfptegqsyrzjy",
			nil,
			[]byte{
		...
		{
			"ae1rspm7ps49gar9ft5g0tkl6lhxs8ygeakqt5y5ln",
			nil,
			[]byte{
