...
SERVER_URL="https://github.com/aerium-network/aerium/releases/download/v${VERSION}"

# Set the filename of the binary and checksum
CHECKSUM_FILE="SHA256SUMS"

# Set the filename of the binary and checksum
FILE_NAME="aerium-cli_${VERSION}_${OS}_${ARCH}${EXT}"

# Destination directory that is the current directory
DEST_DIR="$(pwd)"
EXTRACTED_DIR="${DEST_DIR}/aerium-cli_${VERSION}"
